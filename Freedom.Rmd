...
library(readxl)
Industr <- read_excel("API_NV.IND.MANF.KD.ZG_DS2_es_excel_v2_1220266.xlsx")
View(API_NV_IND_MANF_KD_ZG_DS2_es_excel_v2_1220266)
names(Industr)=c("Country","C1","IndGrowth2018")
Industr=na.omit(Industr)
Industr=Industr[,c(1,3)]
Industr=Industr[c(2:197)]
...
Industr[,]=lapply(Industr[,], trimws,whitespace = "[\\h\\v]")
